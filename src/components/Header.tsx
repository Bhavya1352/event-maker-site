  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm shadow-lg py-4 px-6 flex items-center justify-between fixed top-0 left-0 w-full z-50">
      <div className="flex items-center">
        ...
        <nav className="hidden lg:flex space-x-8 ml-8">
          ...
          <div className="relative group">
            <button className="text-gray-700 hover:text-pink-600 font-semibold transition-all duration-300 hover:scale-110 hover:bg-pink-50 px-3 py-2 rounded-full flex items-center">
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-xl border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-t-lg">Anniversary</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Birthdays</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Gifts</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Candlelight Dinners</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Decorations</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Festivals</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600">Kid's Celebrations</a>
              <a href="/services" className="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-b-lg">Corporate Events</a>
            </div>
          </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <Button className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-6 py-2 font-semibold shadow-lg transform hover:scale-105 transition-all duration-300 hidden md:block">
          Book Now
        </Button>
      ...
      {isMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-lg lg:hidden">
          <nav className="flex flex-col p-4 space-y-4">
            ...
            <Button className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-6 py-2 font-semibold w-full">
              Book Now
            </Button>
          </nav>
        </div>
